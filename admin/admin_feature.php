...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<table class="table table-hover" >
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='delete.php?id=".$id."' class='btn btn-danger' rel='facebox'><i class='icon-trash icon-white'></i> Delete</a> ";
 ...
 $row = mysqli_fetch_array($result);
  ...
  $que = mysqli_query($conn, "UPDATE `stock` SET `qty` = '$total' WHERE `product_id`='$pid'") or die(mysqli_error($conn));
