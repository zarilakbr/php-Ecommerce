...
<div id="container">
	...
	<div id="carousel">
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/benner11.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/benner12.webp" class="carousel"></div>
	...
	<div id="video">
		<video controls autoplay width="445px" height="300px">
			<source src="video/Iklan Sepatu Nike Keren !!!.mp4" type="video/mp4">
		</video>
	</div>
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			...
			<?php 
				...
				$query = mysqli_query($conn, "SELECT *FROM product WHERE category='feature' ORDER BY product_id DESC") or die (mysqli_error($conn));
